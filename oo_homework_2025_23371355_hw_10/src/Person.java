...
public class Person implements PersonInterface {
    ...
    private HashMap<Integer, ArticleNode> map;
    ...
    public ArrayList<Integer> getReceivedArticles() {
        return receivedArticles.transferToList();
    }

    public ArrayList<Integer> queryReceivedArticles() {
        return receivedArticles.queryList();
    }
