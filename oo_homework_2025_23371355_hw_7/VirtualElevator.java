...
public class VirtualElevator {
    ...
    public VirtualElevator(int totalPriority, boolean isUp, ArrayList<Person> people,
        ...
        ScheRequest scheRequest, long lastScheduleTime, int scale, long startTime, String side,
        TransferArea transferArea, boolean isUpdate) {
        this.people = people;
        this.isUp = isUp;
    ...
    public void shareTransferArea(VirtualElevator elevator, int transferFloor) {
        side = "up";
        elevator.side = "down";
        transferArea.setTransferFloor(transferFloor);
        elevator.transferArea = transferArea;
        notifyAll();
    }
    ...
    public void addPerson(Person person) {
        if ((side.equals("up") && person.isLower(transferArea.getTransferFloor())
            || (side.equals("down") && person.isHigher(transferArea.getTransferFloor())))) {
            virtualTime = Double.POSITIVE_INFINITY;
            people.clear();
        }
        else {
            people.add(person);
