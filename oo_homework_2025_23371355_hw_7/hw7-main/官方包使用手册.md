...
本接口用于**第三次电梯作业**，可参照下文中的 demo 示例进行调用获取请求对象。
...
public class UpdateRequest extends Request {
    ...
    **/
     ...
     * @return 目标楼层
     */
    public String getTransferFloor() {
    ...
    public String toString() {
        return String.format("UPDATE-ACCEPT-%d-%d-%s", this.elevatorId1, this.elevatorId2, this.transferFloor);
    }
     ...
     */
    public int hashCode() {
        return Arrays.hashCode(new Object[]{this.elevatorId1, this.elevatorId2, this.transferFloor});
    }
    ...
    public boolean equals(Object obj) {
        if (obj == this) {
            ...
            return req.elevatorId1.equals(this.elevatorId1) && req.elevatorId2.equals(this.elevatorId2) && req.transferFloor.equals(this.transferFloor);
        }
    }
}
```
        ...
        while (true) {
            ...
            if (request == null) {
                ...
                if (request instanceof PersonRequest) {
                    ...
                    // 实际作业中无需打印updateRequest，会自动输出要求的 ACCEPT 格式
...
* stdout
```shell
[   0.7900]UPDATE-ACCEPT-6-4-F1
[   0.7910]SCHE-ACCEPT-2-0.3-B1
674-PRI-10-FROM-B3-TO-B2
```
